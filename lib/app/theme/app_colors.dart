...
class AppColors {
  // Primary Colors
  static const Color primaryLight = Color(0xFF63B3ED); // Deep Blue
  static const Color primaryDark = Color(0xFFF2C94C); // yellow
  ...
  static const Color backgroundDark =
      Color.fromARGB(255, 0, 0, 0); // Dark Blue Gray
